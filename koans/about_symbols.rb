...
class AboutSymbols < Neo::Koan
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    assert_equal true, symbol1           == symbol2
    ##oh weird. it is considered the same object in memory
    assert_equal true, symbol1.object_id == symbol2.object_id
  end

  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }
    # print(symbols_as_strings)
    ##jeeez, there are a lot of symbols
  ...
  # awe - man the answer to this one is weird. 
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      #awe so essentially methods become symbols, but constants don't 
  ...
  def test_symbols_can_be_made_from_strings
    string = "catsAndDogs"
    #interesting. so you can just convert it to a symbol
  ...
  def test_symbols_with_interpolation_can_be_built
    ...
    #awe, it evaluates the string first before turning to symbol
